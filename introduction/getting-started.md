...
> ⚠️ **Start URL이나 계정 정보를 모르겠다면?**
> 진행자에게 바로 문의하세요. 워크샵 시작 전 미리 배포된 안내문을 확인해보세요.
...
> 📸 *스크린샷 삽입: lghh_products_2026.csv 다운로드 완료 화면*
...
> 📸 *스크린샷 삽입: beauty-brand-guide.md 다운로드 완료 화면*
...
👉 다음: [Module 1: Steering](../module1-steering/README.md)
